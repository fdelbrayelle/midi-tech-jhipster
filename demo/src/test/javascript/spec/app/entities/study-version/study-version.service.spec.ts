...
describe('Service Tests', () => {
  describe('StudyVersion Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a StudyVersion', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            creationDate: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a StudyVersion', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            creationDate: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of StudyVersion', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            creationDate: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a StudyVersion', async () => {
